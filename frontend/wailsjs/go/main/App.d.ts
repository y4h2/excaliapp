...
export function CheckRecoveryFiles():Promise<Array<main.RecoveryInfo>>;

export function CloseCurrentFile():Promise<void>;

export function DeleteFile(arg1:string):Promise<void>;

export function DiscardBackup(arg1:string):Promise<void>;
...
export function RecoverFromBackup(arg1:string):Promise<string>;

export function RenameFile(arg1:string,arg2:string):Promise<string>;

export function SaveBackup(arg1:string):Promise<void>;
